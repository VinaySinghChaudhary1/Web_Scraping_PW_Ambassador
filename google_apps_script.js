...
function createPWAmbassadorFormV4() {
  ...
  var otherCatPage = form.addPageBreakItem().setTitle('Other Course Registration');
  form.addTextItem().setTitle('Enter your desired Course or Batch Name:').setRequired(true);
  form.addMultipleChoiceItem().setTitle('Preferred Mode of Learning:').setChoiceValues(['ONLINE Mode', 'OFFLINE Mode']).setRequired(true);
  form.addMultipleChoiceItem().setTitle('Preferred Batch Language:').setChoiceValues(['Hinglish Language', 'English Medium', 'Hindi Medium']).setRequired(true);
  otherCatPage.setGoToPage(FormApp.PageNavigationType.SUBMIT);
  ...
  categoryQuestion.setChoices([
    ...
    categoryQuestion.createChoice('Other / Course Not Listed', otherCatPage)
  ]);
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Vidyapeeth 11 JEE (Target 2028) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Pathshala 11th JEE (Target 2028) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_2 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (Hindi) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna JEE Hindi 2.0 2027 (Price: Rs. 3199 | Rs. 5200 38% OFF)", "Arjuna JEE Hindi 2027 (Price: Rs. 3499 | Rs. 5500 36% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_3 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (English) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna JEE in English 2027 (Price: Rs. 4200 | Rs. 6300 33% OFF)", "Arjuna Power Batch JEE Target 2028 (English) (J1111EE26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_4 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (Bilingual) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna MHT-CET 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Arjuna Bangla (WBJEE + Biology) 2027 + Lakshya Bangla (WBJEE + Biology) 2028 (Price: Rs. 7200 | Rs. 12000 40% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_5 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (Gujrati) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna JEE Gujarati 2027 (Price: Rs. 5500 | Rs. 7000 21% OFF)", "Arjuna JEE Gujarati 2027 Pro + Tab (Price: Rs. 23000 | Rs. 27000 15% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_6 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (Kannada) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna KCET 2027 (Price: Rs. 4499 | Rs. 6500 31% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_0_7 = form.addPageBreakItem().setTitle('IIT-JEE - Class 11 | ONLINE (Bangla) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna Bangla (WBJEE + Biology) 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya JEE 2027 (Price: Rs. 4999 | Rs. 6000 17% OFF)", "Lakshya JEE 2.0 2027 (Price: Rs. 4900 | Rs. 5500 11% OFF)", "Lakshya Power Batch JEE Target 2027 3.1 (J1231EB26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "PARISHRAM 2027 (Class 12th) (Price: Rs. 3500 | Rs. 4800 27% OFF)", "JEE College Counselling: Masterclass (Price: Rs. 199 | Rs. 999 80% OFF)", "LAKSHYA JEE 2027 + PARISHRAM 2027 (Price: Rs. 7500 | Rs. 11100 32% OFF)", "BITSAT Crash Course 2026 (Price: Rs. 499 | Rs. 4430 89% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_1 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | OFFLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Vidyapeeth 12th JEE (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Pathshala 12th JEE (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_2 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (Hindi) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya JEE Hindi 2.0 2027 (Price: Rs. 3199 | Rs. 5200 38% OFF)", "Lakshya JEE Hindi 2027 (Price: Rs. 3499 | Rs. 5500 36% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_3 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (Bilingual) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya MHTCET 2.0 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Lakshya MHT-CET 0.0 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Lakshya MHT-CET 2027 + Parishram Maharashtra HSC 2027 (Price: Rs. 6999 | Rs. 9999 30% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_4 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (English) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya JEE in English 2027 (Price: Rs. 4200 | Rs. 6300 33% OFF)", "Lakshya Power Batch  JEE Target 2027 (English) (J1211EE26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_5 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (Gujrati) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya JEE Gujarati 2027 (Price: Rs. 5500 | Rs. 7000 21% OFF)", "Lakshya JEE Gujarati Pro +Tab 2027 (Price: Rs. 23000 | Rs. 25500 10% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_6 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (Kannada) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya KCET 2027 (Price: Rs. 4999 | Rs. 6500 23% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_1_7 = form.addPageBreakItem().setTitle('IIT-JEE - Class 12 | ONLINE (Bangla) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya Bangla (WBJEE + Biology) 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Prayas 2.0 2027 (Price: Rs. 4900 | Rs. 6000 18% OFF)", "Prayas 2.0 2027 INFINITY PRO (Price: Rs. 11500 | Rs. 29072 60% OFF)", "Prayas Power Batch JEE Target 2027 3.1 (J1331MB26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Prayas 2027 (Price: Rs. 4999 | Rs. 6000 17% OFF)", "JEE College Counselling: Masterclass (Price: Rs. 199 | Rs. 999 80% OFF)", "BITSAT Crash Course 2026 (Price: Rs. 499 | Rs. 4430 89% OFF)", "NIRMAAN GATE 2029 - Civil (With Basics & AI Fundamentals) (Price: Rs. 32000 | Rs. 65343 51% OFF)", "NIRMAAN GATE 2029 - Civil (With Basics & AI Fundamentals) without Books (Price: Rs. 30000 | Rs. 58000 48% OFF)", "NIRMAAN GATE 2029 - Computer Science & IT (With Basics & AI Fundamentals) (Price: Rs. 32000 | Rs. 65247 51% OFF)", "NIRMAAN GATE 2029 - Computer Science & IT (With Basics & AI Fundamentals) without Books (Price: Rs. 30000 | Rs. 58000 48% OFF)", "NIRMAAN GATE 2029 - Electrical (With Basics & AI Fundamentals) (Price: Rs. 32000 | Rs. 65247 51% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_2_1 = form.addPageBreakItem().setTitle('IIT-JEE - Dropper | ONLINE (Hindi) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Prayas JEE Hindi 2.0 2027 (Price: Rs. 3199 | Rs. 5200 38% OFF)", "Prayas JEE Hindi 2027 (Price: Rs. 3499 | Rs. 5500 36% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_2_2 = form.addPageBreakItem().setTitle('IIT-JEE - Dropper | OFFLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Vidyapeeth Dropper JEE (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Pathshala DROPPER JEE (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_2_3 = form.addPageBreakItem().setTitle('IIT-JEE - Dropper | ONLINE (Bilingual) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Prayas MHT-CET 2027 (Dropper) (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Lakshya MHT-CET 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_2_4 = form.addPageBreakItem().setTitle('IIT-JEE - Dropper | ONLINE (Gujrati) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya JEE Gujarati 2027 (Price: Rs. 5500 | Rs. 7000 21% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Arjuna NEET hindi 2027 (Price: Rs. 3499 | Rs. 5500 36% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Yakeen 2.0 2027 (Price: Rs. 4900 | Rs. 6000 18% OFF)", "Lakshya NEET 2.0 2027 (Price: Rs. 4900 | Rs. 5500 11% OFF)", "Lakshya Power Batch NEET Target 2027 3.1 (N1231EB26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Lakshya NEET 2027 (Price: Rs. 4999 | Rs. 6000 17% OFF)", "Yakeen Neet 2.0 2027 Infinity Pro (Price: Rs. 13500 | Rs. 34175 60% OFF)", "PARISHRAM 2027 (Class 12th) (Price: Rs. 3500 | Rs. 4800 27% OFF)", "MISSION 100 NEET 2026 (Price: Rs. 499 | Rs. 3000 83% OFF)", "LAKSHYA NEET 2027 + PARISHRAM 2027 (Price: Rs. 7500 | Rs. 11100 32% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_4_1 = form.addPageBreakItem().setTitle('NEET - Class 12 | OFFLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Vidyapeeth 12th NEET (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Pathshala 12th NEET (Target 2027) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_4_2 = form.addPageBreakItem().setTitle('NEET - Class 12 | ONLINE (Hindi) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya NEET Hindi 2027 (Price: Rs. 3499 | Rs. 5500 36% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_4_3 = form.addPageBreakItem().setTitle('NEET - Class 12 | ONLINE (Gujrati) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya NEET Gujarati 2027 (Price: Rs. 5500 | Rs. 7000 21% OFF)", "Lakshya NEET Gujarati Pro +Tab 2027 (Price: Rs. 25000 | Rs. 28000 11% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_4_4 = form.addPageBreakItem().setTitle('NEET - Class 12 | ONLINE (English) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya NEET in English 2027 (Price: Rs. 4200 | Rs. 6300 33% OFF)", "Lakshya Power Batch NEET Target 2027 (English) (N1211EE26) (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_4_5 = form.addPageBreakItem().setTitle('NEET - Class 12 | ONLINE (Bilingual) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Lakshya MHT-CET 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Lakshya MHT-CET 0.0 2027 (Price: Rs. 4600 | Rs. 6000 23% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Vidyapeeth Residential Program 12 NEET (Price: Rs. 5000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Surya 3.0 SSC CGL Target 2026 (Price: Rs. 999 | Rs. 1699 41% OFF)", "SSC CGL Mahapack (Price: Rs. 2199 | Rs. 3499 37% OFF)", "SAFAR 3.0 SSC CGL | CHSL 2027 with English Books (Price: Rs. 2499 | Rs. 3499 29% OFF)", "SSC Mahapack Pro (Price: Rs. 2999 | Rs. 6249 52% OFF)", "Kamyabi 3.0 SSC CHSL Target 2026 (Price: Rs. 1249 | Rs. 1999 38% OFF)", "Surya 2.0 SSC CGL Target 2026 (Price: Rs. 999 | Rs. 1699 41% OFF)", "SSC CHSL Mahapack (Price: Rs. 1999 | Rs. 2999 33% OFF)", "SAFAR 3.0 SSC CGL | CHSL 2027 with Hindi Books (Price: Rs. 2499 | Rs. 3499 29% OFF)", "Akshay SSC Stenographer 2026 (Price: Rs. 999 | Rs. 2499 60% OFF)", "Vishwas SSC GD 2027 (Price: Rs. 599 | Rs. 999 40% OFF)", "Karmath SSC MTS/Havaldar 2026 (Price: Rs. 599 | Rs. 999 40% OFF)", "Yogdaan SSC CPO Target 2026 (Price: Rs. 1499 | Rs. 1999 25% OFF)", "SSC & Railway Mahapack Pro (Price: Rs. 3499 | Rs. 11499 70% OFF)", "Aagaaz SSC Selection Post Phase XIV (Price: Rs. 999 | Rs. 2499 60% OFF)", "SSC GD MTS Mahapack (Price: Rs. 899 | Rs. 2499 64% OFF)", "SSC MTS/Havaldar 2026 Video Course (Price: Rs. 499 | Rs. 999 50% OFF)", "SSC GD Constable Complete Video Course 2026-27 (Price: Rs. 499 | Rs. 999 50% OFF)", "Maths Special Recorded Batch (Arithmetic and Advance) (Price: Rs. 599 | Rs. 1499 60% OFF)", "English Special Recorded Batch (Grammar + Vocab) (Price: Rs. 499 | Rs. 1249 60% OFF)", "Reasoning Special Recorded Batch for All SSC Exams (Price: Rs. 499 | Rs. 1249 60% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["IPMAT MASTERQUEST 2.0 2027 (Price: Rs. 4499 | Rs. 8180 45% OFF)", "IPMAT MASTERQUEST 2027 (Price: Rs. 4499 | Rs. 9999 55% OFF)", "IPMAT PRO 2027 (Price: Rs. 7499 | Rs. 14999 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_8_1 = form.addPageBreakItem().setTitle('College Entrance Exams ( UG & PG ) - IPMAT | OFFLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Superclass - IPMAT Masterquest 2027 (Price: Rs. 4999 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Design Power Batch 2027 (Price: Rs. 4999 | Rs. 0 0% OFF)", "DESIGN PRO 2027 (Price: Rs. 13499 | Rs. 26999 50% OFF)", "Design Iconic 3.0 2027 (Price: Rs. 7999 | Rs. 16999 53% OFF)", "Design Iconic 2.0 2027 (Price: Rs. 8999 | Rs. 18999 53% OFF)", "DESIGN ICONIC 2027 (Price: Rs. 9999 | Rs. 20999 52% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Architecture Pro 2027 (Price: Rs. 10999 | Rs. 24999 56% OFF)", "Architecture Creators 2.0 2027 (Price: Rs. 6999 | Rs. 13999 50% OFF)", "Architecture Creators 2027 (Price: Rs. 7999 | Rs. 19999 60% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["MBA IGNITE 2026 (CAT + OMETs) (Price: Rs. 6999 | Rs. 14999 53% OFF)", "MBA ELITE WEEKEND 2026 (CAT + OMETs) (Price: Rs. 5999 | Rs. 14999 60% OFF)", "MBA Pro 2026 (CAT + OMETs) (Price: Rs. 11999 | Rs. 27999 57% OFF)", "MBA ELITE 2026 (CAT + OMETs) (Price: Rs. 5999 | Rs. 14999 60% OFF)", "MBA PIONEER 2026 (CAT + OMETs) (Price: Rs. 5999 | Rs. 15999 63% OFF)", "MBA Core 2026 (Foundation + CAT & OMETs) (Price: Rs. 5999 | Rs. 15999 63% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Teaching Mahapack (Price: Rs. 2499 | Rs. 12999 81% OFF)", "CTET PREMIUM INFINITY 3.0 SEP 2026 PAPER 1 (Price: Rs. 1299 | Rs. 3499 63% OFF)", "CTET PREMIUM INFINITY 3.0 SEP 2026 PAPER 2 MATH & SCIENCE (Price: Rs. 1499 | Rs. 3999 63% OFF)", "CTET PREMIUM INFINITY 3.0 SEP 2026 PAPER 2 SST (Price: Rs. 1499 | Rs. 3999 63% OFF)", "CTET PREMIUM COMBO INFINITY 3.0 SEP 2026 PAPER 1 & PAPER 2 SST (Price: Rs. 1799 | Rs. 4799 63% OFF)", "CTET PREMIUM COMBO INFINITY 3.0 SEP 2026 PAPER 1 & PAPER 2 MATH & SCIENCE (Price: Rs. 1799 | Rs. 4799 63% OFF)", "DSSSB TGT Computer Science 2026 (Price: Rs. 1599 | Rs. 4799 67% OFF)", "CTET PREMIUM 3.0 SEP 2026 PAPER 1 (Price: Rs. 749 | Rs. 1999 63% OFF)", "CTET PREMIUM 3.0 SEP 2026 PAPER 2 MATH & SCIENCE (Price: Rs. 949 | Rs. 2599 63% OFF)", "CTET PREMIUM 3.0 SEP 2026 PAPER 2 SST (Price: Rs. 949 | Rs. 2599 63% OFF)", "CTET PREMIUM COMBO 3.0 SEP 2026 PAPER 1 & PAPER 2 SST (Price: Rs. 1249 | Rs. 3339 63% OFF)", "CTET PREMIUM COMBO 3.0 SEP 2026 PAPER 1 & PAPER 2 MATH & SCIENCE (Price: Rs. 1249 | Rs. 3339 63% OFF)", "CTET PREMIUM INFINITY 2.0 SEP 2026 PAPER 1 (Price: Rs. 1299 | Rs. 3499 63% OFF)", "CTET PREMIUM INFINITY 2.0 SEP 2026 PAPER 2 MATH & SCIENCE (Price: Rs. 1499 | Rs. 3999 63% OFF)", "CTET PREMIUM INFINITY 2.0 PAPER 2 SST SEP 2026 (Price: Rs. 1499 | Rs. 3999 63% OFF)", "UPTET Revision+Practice Batch 2026 Paper 1 & Paper 2 (Price: Rs. 499 | Rs. 999 50% OFF)", "CTET PREMIUM COMBO INFINTY 2.0 SEP 2026 (Paper 1 & Paper 2 Maths & Science) (Price: Rs. 1799 | Rs. 4799 63% OFF)", "CTET PREMIUM COMBO INFINITY 2.0 SEP 2026 (Paper 1 & Paper 2 SST) (Price: Rs. 1799 | Rs. 4799 63% OFF)", "CTET PREMIUM 2.0 SEP 2026 PAPER 1 (Price: Rs. 749 | Rs. 1999 63% OFF)", "CTET PREMIUM 2.0 PAPER 2 MATH & SCIENCE SEP 2026 (Price: Rs. 949 | Rs. 2599 63% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Certification program  in Banking, Financial Services & Insurance (Price: Rs. 29999 | Rs. 49999 40% OFF)", "ITR Filing Course: ITR 1 to ITR 4 — Step by Step (Price: Rs. 999 | Rs. 1999 50% OFF)", "Stock Market For Beginners (Price: Rs. 2500 | Rs. 4000 37% OFF)", "NISM Series V-A & V-B - Mutual Fund Foundation (Price: Rs. 1499 | Rs. 3000 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["NISM Series XII - Securities Markets Foundation (Price: Rs. 1499 | Rs. 3000 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Finance, Tax and Accounting Course - (Batch-19) Pre (Price: Rs. 29999 | Rs. 39999 25% OFF)", "Finance, Tax and Accounting Course - (Batch-19) Pro (Price: Rs. 34999 | Rs. 49999 30% OFF)", "ITR Filing Course: ITR 1 to ITR 4 — Step by Step (Price: Rs. 999 | Rs. 1999 50% OFF)", "AI in Finance (Price: Rs. 1499 | Rs. 2999 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Financial Modeling with AI (Price: Rs. 16999 | Rs. 34999 51% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["TallyPrime Basic with GST Essentials (Tally Certification) (Price: Rs. 1500 | Rs. 2999 49% OFF)", "TallyPrime Advance with GST Accounting (Tally Certification) (Price: Rs. 2200 | Rs. 4500 51% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Video Editing with AI - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "Data Analytics with AI - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "⁠All PC Courses (Combo) - Earners (Price: Rs. 3999 | Rs. 20000 80% OFF)", "Coding & Web Development - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "DSA in C++ - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "AI & Machine Learning - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "⁠Graphic Design with AI - Earners (Price: Rs. 2800 | Rs. 10000 72% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Mobile Video Editing - Earners (Price: Rs. 800 | Rs. 1500 47% OFF)", "All Mobile Courses (Combo)- Earners (Price: Rs. 1300 | Rs. 7500 83% OFF)", "AI & ChatGPT - Earners (Price: Rs. 800 | Rs. 1500 47% OFF)", "YouTube Content Creation – Earners (Price: Rs. 800 | Rs. 1500 47% OFF)", "Instagram & Social Media – Earners (Price: Rs. 800 | Rs. 1500 47% OFF)", "Mobile Graphic Designing – Earners (Price: Rs. 800 | Rs. 1500 47% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Spoken English by PW Talk 12 Months (Price: Rs. 1199 | Rs. 3599 67% OFF)", "Spoken English by PW Talk 6 Months (Price: Rs. 799 | Rs. 1799 56% OFF)", "Spoken English by PW Talk 3 Months (Price: Rs. 699 | Rs. 899 22% OFF)", "Spoken English by PW Talk (Price: Rs. 699 | Rs. 899 22% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["PW Gyaan-E Master AI + Excel Course (Price: Rs. 499 | Rs. 999 50% OFF)", "PW Gyaan-E Go Viral (Price: Rs. 499 | Rs. 999 50% OFF)", "PW Gyaan-E Get Job Ready (Price: Rs. 499 | Rs. 999 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Intensive Artist Training Program (Price: Rs. 1999 | Rs. 2999 33% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["MBA PIONEER 2026 (CAT + OMETs) (Price: Rs. 5999 | Rs. 15999 63% OFF)", "Personality Development Programme (Price: Rs. 10000 | Rs. 20000 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_31_1 = form.addPageBreakItem().setTitle('Online Degree | ONLINE (English) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Professional Course On Communication and Behavior Skills (Price: Rs. 5000 | Rs. 10000 50% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Study Abroad - MBBS - Administrative Charges - $2000 (Price: Rs. 192000 | Rs. 0 0% OFF)", "Study Abroad - MBBS - Processing Fees - ₹15,000 (Price: Rs. 15000 | Rs. 0 0% OFF)", "Study Abroad - Masters/ Bachelors (Germany) Processing Fees - ₹25,000 (Price: Rs. 25000 | Rs. 0 0% OFF)", "Study Abroad - Bachelors (Albania) Processing Fees - ₹10,000 (Price: Rs. 10000 | Rs. 0 0% OFF)", "Study Abroad - Bachelors (Albania) Processing Fees - ₹50,000 (Price: Rs. 50000 | Rs. 0 0% OFF)", "Study Abroad - Bachelors (Albania) Visa Consultation - ₹87,500 (Price: Rs. 87500 | Rs. 0 0% OFF)", "Study Abroad - Diploma (Malaysia) Processing Fees - ₹25,000 (Price: Rs. 25000 | Rs. 0 0% OFF)", "Study Abroad - Masters/ Bachelors (Germany) Processing Fees - ₹80,000 (Price: Rs. 80000 | Rs. 0 0% OFF)", "Study Abroad - Diploma (Malaysia) Processing Fees - ₹100,000 (Price: Rs. 100000 | Rs. 0 0% OFF)", "Study Abroad - Masters/ Bachelors (Germany) Visa Consultation - ₹95,000 (Price: Rs. 95000 | Rs. 0 0% OFF)", "Study Abroad - Diploma (Malaysia) Visa Consultation - ₹100,000 (Price: Rs. 100000 | Rs. 0 0% OFF)", "Study Abroad - Diploma (Malaysia) Service Charges - ₹223,000 (Price: Rs. 223000 | Rs. 0 0% OFF)", "Study Abroad - Nursing - Processing Fees - ₹10,000 (Price: Rs. 10000 | Rs. 0 0% OFF)", "Study Abroad - Nursing - Processing Fees - ₹50,000 (Price: Rs. 50000 | Rs. 0 0% OFF)", "Study Abroad - Nursing - Processing Fees - ₹87,500 (Price: Rs. 87500 | Rs. 0 0% OFF)", "Study Abroad - Nursing - Administrative Charges - $1000 (Price: Rs. 95000 | Rs. 0 0% OFF)", "Study Abroad - MBBS - Processing Fees - ₹29,500 (Price: Rs. 29500 | Rs. 0 0% OFF)", "Study Abroad - MBBS - Processing Fees - ₹50,000 (Price: Rs. 50000 | Rs. 0 0% OFF)", "Study Abroad - MBBS - Processing Fees - ₹174,000 (Price: Rs. 174000 | Rs. 0 0% OFF)", "Study Abroad - MBBS - Processing Fees - ₹169,000 (Price: Rs. 169000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["PW Institute Of Innovation - School of Technology || Noida Campus (Price: Rs. 11 | Rs. 0 0% OFF)", "PW Institute Of Innovation - School of Technology || Lucknow Campus (Price: Rs. 11 | Rs. 0 0% OFF)", "PW Institute Of Innovation - School of Technology || Pune Campus (Price: Rs. 11 | Rs. 0 0% OFF)", "PW Institute Of Innovation - School of Technology || Bangalore Campus (Price: Rs. 11 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Data Analytics With AI Course (Price: Rs. 6999 | Rs. 9999 30% OFF)", "Data Science With Generative AI Course (Price: Rs. 6999 | Rs. 9999 30% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_34_1 = form.addPageBreakItem().setTitle('Skills - Data Science | OFFLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Data Analytics with Gen AI (Offline Batch) (Price: Rs. 50000 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_34_2 = form.addPageBreakItem().setTitle('Skills - Data Science | ONLINE (English) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["AI/ML Launchpad Bootcamp (Price: Rs. 29 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Digital Marketing with AI (Offline Batch) (Price: Rs. 49999 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_35_1 = form.addPageBreakItem().setTitle('Skills - Digital Marketing with AI | ONLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Digital Marketing with AI Course (Price: Rs. 9999 | Rs. 20000 50% OFF)", "Social Media Marketing Course (Price: Rs. 7999 | Rs. 8999 11% OFF)", "How to Start Your Digital Marketing Agency (Price: Rs. 49 | Rs. 0 0% OFF)", "Digital Marketing with AI + Social Media Marketing (Price: Rs. 39999 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Full Stack Development with AI (Price: Rs. 6999 | Rs. 8999 22% OFF)", "Decode Python with DSA Course 1 (Price: Rs. 3499 | Rs. 4999 30% OFF)", "Decode C++ with DSA Course (Price: Rs. 3499 | Rs. 4999 30% OFF)", "Decode Java with DSA Course (Price: Rs. 3499 | Rs. 4999 30% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_36_1 = form.addPageBreakItem().setTitle('Skills - Software Development | ONLINE (Hinglish) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Certified Ethical Hacking Course (Price: Rs. 4999 | Rs. 9999 50% OFF)", "DevOps and Cloud Computing Course (Price: Rs. 24999 | Rs. 30000 16% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Post-Graduate Certificate Programme in AI-Driven FinTech (PGCPF) (Price: Rs. 590 | Rs. 0 0% OFF)", "AI-Driven Robotics: Design, Intelligence and Automation (Price: Rs. 590 | Rs. 0 0% OFF)", "Professional Certificate Programme in Generative AI and Machine Learning (Price: Rs. 590 | Rs. 0 0% OFF)", "Professional Certificate Programme in Gen AI in Digital Marketing (Price: Rs. 590 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Executive Certificate Programme in AI-Driven Marketing & Digital Growth (Price: Rs. 590 | Rs. 0 0% OFF)", "Executive Certificate Program in Digital Finance and FinTech (Price: Rs. 590 | Rs. 0 0% OFF)", "Professional Certificate Programme in Digital Marketing and Growth (Price: Rs. 1298 | Rs. 0 0% OFF)", "Post-Graduate Certificate Programme in AI-Driven General Management (Price: Rs. 590 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["PW COMPLETE ADVOCACY PROGRAM (Price: Rs. 17999 | Rs. 29999 40% OFF)", "PW Legal Drafting Certification Program 2026 (Price: Rs. 5999 | Rs. 10997 45% OFF)", "PW ADVANCED CIVIL LITIGATION & LEGAL DRAFTING PROGRAM 2026 (Price: Rs. 12999 | Rs. 24999 48% OFF)", "PW ADVANCED CRIMINAL LITIGATION & LEGAL DRAFTING PROGRAM 2026 (Price: Rs. 12999 | Rs. 24999 48% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  var coursePage_40_1 = form.addPageBreakItem().setTitle('Skills - Legal Skills | ONLINE (Bilingual) Courses');
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["PW VAKIL TOOLKIT (Price: Rs. 499 | Rs. 899 44% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
  ...
  form.addCheckboxItem()
    .setTitle('Select one or more courses to register for:')
    .setChoiceValues(["Municipal Managment Course (Price: Rs. 299 | Rs. 0 0% OFF)", "Other (Please specify below)"])
    .setRequired(true);
  form.addTextItem().setTitle('If you chose Other, enter the Course/Batch Name here:');
